...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            # print("eos_mask.shape ",eos_mask.shape)
            ...
            if eos_bbsz_idx.numel() > 0:
                ...
                # print("finalized_sents ",len(finalized_sents))
                # if len(finalized_sents)>=40:
                #     # break
                #     print(finalized_sents)
                #     exit()
                num_remaining_sent -= len(finalized_sents)
            # print("len(finalized[0] ",len(finalized[0]))
            # print("finalized_sents ", len(finalized_sents))
        ...
        for sent in range(len(finalized)):
            ...
            # print("finalized[sent]",len(finalized[sent]))
            _, sorted_scores_indices = torch.sort(scores, descending=True)
            # print("sorted_scores_indices_len ",len(sorted_scores_indices))
