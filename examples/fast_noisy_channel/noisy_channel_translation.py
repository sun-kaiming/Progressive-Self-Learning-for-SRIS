...
class NoisyChannelTranslation(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--channel-scoring-type', default='log_norm',
                            choices=['unnormalized', 'log_norm', 'k2_separate', 'src_vocab', 'src_vocab_batched'],
    ...
    def build_generator(
        ...
        if getattr(args, "score_reference", False):
            ...
            if self.args.channel_model is not None:
                channel_models, _ = checkpoint_utils.load_model_ensemble(self.args.channel_model.split(':'),
                                                                         task=channel_task)
